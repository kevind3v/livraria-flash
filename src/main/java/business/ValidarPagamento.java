    ...
    public String processar(EntidadeDominio entidade) {
        ...
        if(cartao != null) {
            ...
            if(!cupDao.validarCupom(cupom)) {
                sb.append("Cupom invalido, ja foi resgatado, nao pertence a esse cliente ou Cupom vencido;");
                sb.append("Verifique cupons disponiveis: 'Sua Conta > Cupons';");
            }else {
                for(Cupom c : pagamento.getCupons()) {
                ...
                if(restante.doubleValue() <= 0) {
                    sb.append("Nao e possivel adicionar esse cupom porque o valor excede o total da compra de forma desnecessaria. ");
