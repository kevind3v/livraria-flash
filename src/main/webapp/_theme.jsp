...
<body>
    <div id="loading">
        <div class="navbar-brand brand d-flex app-brand-logo" style="justify-content: center;align-items: center;height: 100%;font-size: 70px">
            <i class="fas fa-bolt"></i> <span class="ml-2" style="font-weight: 800;">Flash</span>
        </div>
    </div>
